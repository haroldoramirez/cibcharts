angular.module("cibcharts")
    .controller("haacke.controller", function ($scope, $state, $stateParams, BaseTotal, BaseCalculadaDia, BasePing, toastr, $q, $timeout, Usuario, $rootScope) {
