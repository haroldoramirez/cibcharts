angular.module("cibcharts")
    .controller("starmilk.controller", function ($rootScope, $scope, $state, $stateParams, BaseTotal, BaseCalculadaDia, BasePing, toastr, $q, $timeout, Usuario) {
        ...
        $scope.loading = true;
        $scope.nomePropriedade = "Starmilk";
...
/*                ' ',
            ...
            var pdf = pdfMake.createPdf(docDefinition).download('cibcharts-starmilk-reports-'+ agora +'.pdf');
