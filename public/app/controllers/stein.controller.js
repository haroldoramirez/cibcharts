angular.module("cibcharts")
    .controller("stein.controller", function ($scope, $state, $stateParams, BaseTotal, BaseCalculadaDia, BasePing, toastr, $q, $timeout, Usuario, $rootScope) {
