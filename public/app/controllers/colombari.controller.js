angular.module("cibcharts")
    .controller("colombari.controller", function ($scope, $state, $stateParams, BaseTotal, BaseCalculadaDia, BasePing, toastr, $q, $timeout, Usuario, $rootScope) {
        ...
        $scope.loading = true;
        $scope.nomePropriedade = "Colombari";
